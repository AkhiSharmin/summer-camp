  ...
  return (
    <div data-aos="zoom-in">
      <h2 className="text-5xl font-bold text-purple-700 text-center pb-20 drop-shadow-2xl uppercase">
        Our Student Drawing Skills
      </h2>
      <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8 pb-24">
        <div>
        ...
        <div>
          ...
          <p className="pb-4">
            <h2 className="pb-3">Terracotta</h2>
            <ProgressBar completed={90} />
          </p>
          <p className="pb-4">
            <h2 className="pb-3">Ceramic Work</h2>
            <ProgressBar completed={70} />
          </p>
          <p>
            <h2 className="pb-3">Clay Models</h2>
